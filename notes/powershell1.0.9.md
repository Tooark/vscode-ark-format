...
- Bump de versão do pacote `ark-format-powershell`: `1.0.8` -> `1.0.9`.
...
- Atualização dos GIFs de demonstração (`media/powershell-settings.gif` e `media/powershell-using.gif`) usados no README/Marketplace.
