...
Thanks for your interest in **Ark Format**! 💙
...
**Use [GitHub Discussions](https://github.com/Tooark/vscode-ark-format/discussions).**
...
<https://github.com/Tooark/vscode-ark-format/issues/new/choose>

Please include:

- **Which extension** (Shell, PowerShell, Makefile, or the pack).
- **Extension version** (Extensions view → the extension → version).
- **VS Code version** (Help → About).
- **Operating system**.
- **A minimal input sample** (before → after) that reproduces the wrong output.
- **Steps to reproduce** and any relevant Output-panel logs.
...
Explain the **problem** you are trying to solve, not just the solution.
...
- **Preferred**: [GitHub Security Advisories](https://github.com/Tooark/vscode-ark-format/security/advisories/new)
...
| **Per extension** | The package README under [`packages/`](packages/)           |
...
- **Repository**: <https://github.com/Tooark/vscode-ark-format>
- **Discussions**: <https://github.com/Tooark/vscode-ark-format/discussions>
